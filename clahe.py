...
if __name__ == '__main__':
	...
	parser = argparse.ArgumentParser(description = 'Perform basic image processing on input by using CLAHE methodology to generate output.')
...
# Convert color space from BGR to LAB
